...
def mock_dependencies():
    ...
    with (
        patch("actions.move_go2_autonomy.connector.unitree_rplidar_sdk.UnitreeGo2RPLidarProvider") as mock_lidar,
        patch("actions.move_go2_autonomy.connector.unitree_rplidar_sdk.UnitreeGo2StateProvider") as mock_state,
        patch("actions.move_go2_autonomy.connector.unitree_rplidar_sdk.SportClient") as mock_sport,
        patch("actions.move_go2_autonomy.connector.unitree_rplidar_sdk.UnitreeGo2OdomProvider") as mock_odom,
    ):
...
class TestMoveUnitreeRPLidarSDKConnectorInit:
    ...
    def test_initialization_sport_client_error(self):
        ...
        with (
            patch("actions.move_go2_autonomy.connector.unitree_rplidar_sdk.UnitreeGo2RPLidarProvider"),
            patch("actions.move_go2_autonomy.connector.unitree_rplidar_sdk.UnitreeGo2StateProvider"),
            patch("actions.move_go2_autonomy.connector.unitree_rplidar_sdk.SportClient") as mock_sport,
            patch("actions.move_go2_autonomy.connector.unitree_rplidar_sdk.UnitreeGo2OdomProvider"),
            patch("actions.move_go2_autonomy.connector.unitree_rplidar_sdk.logging") as mock_logging,
        ):
...
class TestMoveRobot:
    ...
    def test_move_robot_error(self, connector, mock_dependencies):
        ...
        with patch("actions.move_go2_autonomy.connector.unitree_rplidar_sdk.logging") as mock_logging:
            connector._move_robot(0.5, 0.0, 0.0)
